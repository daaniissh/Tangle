...
const Explore = () => {
  return (
    <div className="flex justify-center w-full min-h-screen md:mb-auto mb-20 md:mt-auto mt-0  overflow-y-scroll h-screen ">
      <div className=" h-full w-full lg:ml-96 lg:mr-48  ">
        <div className="grid gap-1   grid-cols-3 grid-rows-6 md:grid-rows-8  lg:grid-rows-3 md:mt-8 mt-16 ">
