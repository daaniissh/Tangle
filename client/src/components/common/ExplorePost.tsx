...
const ExplorePost = ({ comments, img, likes }: Props) => {
  return (
    <div className="bg-white  select-none cursor-pointer group md:h-auto h-auto  relative">
      ...
      <div className="w-full h-full">
        <img draggable="false" className='md:w-80  w-32   md:h-80 md:object-cover object-cover aspect-square' src={img} alt="" />
      </div>
    </div>
  )
}
