...
const SubHeader = ({ name, onClick }: p) => {
  return (
    <div className="border-b-[1px] bg-white dark:bg-black dark:border-insta-darkBorder flex gap-2 border-insta-border w-full items-center justify-center h-16 fixed top-0 z-[9999]">
