...
const SubHeader = ({ name, onClick }: p) => {
  return (
    <div className="border-b-[1px] bg-white  dark:bg-black dark:border-insta-darkBorder flex gap-2 border-insta-border w-full items-center justify-center h-16 fixed top-0 z-50">
      <div className="flex w-full flex-[1,2] items-center text-white">
        ...
        <div className="mr-10 w-full flex justify-center">
          <h1 className="text-center capitalize font-semibold text-black dark:text-white dak:text-white">{name}</h1>
        </div>
      </div>
    </div>
