      ...
      <div className="flex flex-col md:flex-row gap-2 w-full h-full">
        ...
        <div className="flex-1 px-2   flex flex-col">
          <div className="text-white flex-1  flex justify- flex-col mt-5 md:mt-8 ">
            <div className="py-2  md:px-4 "><UserAvatar username='da11nsh' className='text-sm' /></div>
            <div
              aria-label="Write a caption..."
              className="w-full h-52   outline-none text-white py-2 px-5 bg-[#121212] rounded-xl placeholder:text-white editable-placeholder"
